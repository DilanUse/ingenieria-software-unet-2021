          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <div class="img-container w-8 mr-3 flex">
                <img :src="require(`@/assets/img/vuexy/file-icons/${suggestion.file_ext}.png`)" :alt="suggestion.file_name" class="responsive">
              </div>
  ...
  computed: {
    ...
    navbarSearchAndPinList() {
      return {
        pages: {
          key: 'title',
          data: this.navMenuItemsByPermissionsLineal,
        },
      };
    },
  },
