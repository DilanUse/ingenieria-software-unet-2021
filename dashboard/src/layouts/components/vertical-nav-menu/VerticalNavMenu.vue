          ...
          <div>
            ...
            <template v-else-if="!showCloseButton && !verticalNavMenuItemsMin">
              <feather-icon
                ...
                class="mr-0 ml-3 cursor-pointer"
                :icon="reduce ? 'ChevronRightIcon' : 'ChevronLeftIcon'"
                svg-classes="stroke-current text-gray-dark"
        ...
        <VuePerfectScrollbar
          ...
          <template v-for="(item, index) in menuItemsUpdated">
            ...
            <span
              ...
              {{ $tc(item.i18n, item.i18nCount || 2) || item.header }}
            </span>
            <!-- /Group Header -->
              ...
              <v-nav-menu-item
                ...
                :slug="item.slug">
                  <span v-show="!verticalNavMenuItemsMin" class="truncate">
                    {{ $tc(item.i18n, item.i18nCount || 2) || item.name }}
                  </span>
                  <vs-chip
...
export default {
  ...
  computed: {
    ...
    ...mapGetters({
      userHasPermissionsTo: 'auth/userHasPermissionsTo',
      authUserRoleName: 'auth/roleName',
      navMenuItemsByPermissions: 'navMenuItemsByPermissions',
    }),
    isGroupActive() {
      return (item) => {
  ...
  created() {
    this.menuItemsUpdated = this.navMenuItemsByPermissions();
  },
  mounted() {
